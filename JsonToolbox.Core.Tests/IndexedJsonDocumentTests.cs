...
public class IndexedJsonDocumentTests
{
    ...
    {
        using IndexedJsonDocument document = IndexedJsonDocument.OpenText(Sample);
    ...
    {
        using IndexedJsonDocument document = IndexedJsonDocument.OpenText("""{"a":{"b":1}}""");
    ...
    {
        using IndexedJsonDocument document = IndexedJsonDocument.OpenText("""{"a":"line\nbreak é"}""");
    ...
    {
        using IndexedJsonDocument document = IndexedJsonDocument.OpenText(JsonScannerTests.BuildDocument(recordCount: 500));
    ...
    {
        using IndexedJsonDocument document = IndexedJsonDocument.OpenText("  \"just a string\"  ");
