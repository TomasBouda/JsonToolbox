...
using JsonExplorer.Core.Editing;
...
public sealed partial class DocumentSession : ObservableObject, IDisposable
{
    ...
    private JsonExplorerDocument _document;
    ...
    public DocumentSession(string path, SessionServices services)
    {
        ...
        _document = JsonExplorerDocument.Open(editable);
    ...
    public JsonExplorerDocument Document => _document;
    ...
    {
        _document = JsonExplorerDocument.Open(_editor.Source);
    ...
    {
        JsonExplorerDocument document = _document;
        SelectedLine = "…";
