...
public class LazyIndexingTests
{
    ...
    {
        using JsonExplorerDocument document = JsonExplorerDocument.OpenText(BuildTopHeavyDocument(200));
    ...
    {
        using JsonExplorerDocument document = JsonExplorerDocument.OpenText(BuildTopHeavyDocument(50));
        var announced = new List<JsonNodeInfo>();
        document.IndexChildren(document.Root, onChildFound: announced.Add);
    ...
    public void Stops_at_the_closing_bracket_of_the_indexed_node()
    {
        ...
        using JsonExplorerDocument document = JsonExplorerDocument.OpenText("""{"a":[1,2,3],"b":[4,5,6,7]}""");
    ...
    {
        using JsonExplorerDocument document = JsonExplorerDocument.OpenText(BuildTopHeavyDocument(10));
        var announced = new List<JsonNodeInfo>();
        document.IndexChildren(document.Root, onChildFound: announced.Add);
