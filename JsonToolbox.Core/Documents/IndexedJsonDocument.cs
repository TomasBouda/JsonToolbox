...
/// </para>
/// </remarks>
public sealed class IndexedJsonDocument : IDisposable
{
    private readonly JsonSource _source;

    private IndexedJsonDocument(JsonSource source, JsonNodeInfo root)
    {
        _source = source;
        Root = root;
    }
    ...
    public static IndexedJsonDocument Open(JsonSource source)
    {
    ...
    public static IndexedJsonDocument OpenText(string json, string displayName = "(in memory)") =>
