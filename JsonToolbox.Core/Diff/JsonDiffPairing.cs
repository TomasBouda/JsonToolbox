...
public sealed class JsonDiffPairing(
    IndexedJsonDocument left,
    IndexedJsonDocument right,
    ...
    CancellationToken cancellationToken = default)
{
    ...
    public IndexedJsonDocument Left => left;

    public IndexedJsonDocument Right => right;
    ...
    private List<JsonNodeInfo> Children(IndexedJsonDocument document, JsonNodeInfo node)
    {
    ...
    private static long Extent(IndexedJsonDocument document, JsonNodeInfo node) =>
    ...
    private IEnumerable<string> NamesOf(IndexedJsonDocument document, JsonNodeInfo node) =>
        document
    ...
    /// </remarks>
    private ulong[] HashRange(IndexedJsonDocument document, List<JsonNodeInfo> children, int start, int count)
    {
